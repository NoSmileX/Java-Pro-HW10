...
<body>
    <div align="center">
        <c:set var="imageLink" value="${avatar}" />
        <c:set var="imagePath" value="${empty imageLink ? 'def.png' : imageLink}" />
        <img src="uploads/${imagePath}" alt="User avatar" width="50px">
        ...
        <form action="${updateUrl}" method="POST" enctype="multipart/form-data">
            ...
            Photo: <br/><input type="file" name="avatar" value="${avatar}" /><br/>
